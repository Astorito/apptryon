...
export const seoIntegrationPages = {
  shopify: {
    ...
    h1: "Virtual Try-On Plugin for Shopify | TryLook-ai",
    subtitle:
  ...
  woocommerce: {
    ...
    h1: "Virtual Try-On Plugin for WooCommerce | TryLook-ai",
    subtitle:
  ...
  webflow: {
    ...
    h1: "Virtual Try-On for Webflow E-commerce | TryLook-ai",
    subtitle:
  ...
  tiendanube: {
    ...
    h1: "Virtual Try-On for Tiendanube | TryLook-ai",
  ...
  mercadoshops: {
    ...
    h1: "Virtual Try-On Integration for Mercado Shops | TryLook-ai",
    subtitle:
  ...
  hostinger: {
    ...
    h1: "Virtual Try-On for Hostinger Stores | TryLook-ai",
    subtitle:
