...
const BeforeAfterSlider = () => {
  ...
  return (
    // Outer wrapper needs overflow visible so widget icon can protrude
    <div className="relative w-full max-w-[410px] mx-auto" style={{ paddingBottom: 28 }}>
      ...
      <img src={pantalon}   alt="Pants"    className="hidden lg:block" style={garmentStyle({ bottom: 96 + 28, left: -116 })} />
      <img src={zapatillas} alt="Sneakers" className="hidden lg:block" style={garmentStyle({ bottom: 96 + 28, right: -116 })} />

      {/* Slider container */}
      <div
        ref={containerRef}
        className="relative aspect-[3/4] w-full rounded-2xl cursor-col-resize select-none z-10"
        style={{ boxShadow: SLIDER_SHADOW, overflow: "visible" }}
      ...
      >
        ...
        <div className="absolute inset-0 rounded-2xl overflow-hidden">
          ...
          <div
            ...
            style={{ left: "50%", transform: "translateX(calc(-50% - 28px))" }}
          >
        ...
        {/* Widget icon — half outside bottom-right corner */}
        <img
          src={widgetIcon}
          alt="Try Look"
